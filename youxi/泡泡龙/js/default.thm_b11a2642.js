window.skins=window.skins||{};
                ...
                generateEUI.skins = {};generateEUI.paths['resource/mySkin/component/ComboEffectItem.exml'] = window.skins.ComboEffectItem = (function (_super) {
...
})(eui.Skin);generateEUI.paths['resource/mySkin/component/LevelItem.exml'] = window.skins.LevelItem = (function (_super) {
	...
	var LevelItem$Skin1 = 	(function (_super) {
		...
		function LevelItem$Skin1() {
			...
			this.states = [
				...
				new eui.State ("down",
					[
						new eui.SetProperty("_Image1","source","star_noEmpty_s_png")
					])
				,
	...
	function LevelItem() {
		...
		this.states = [
			new eui.State ("lock",
				[
					new eui.SetProperty("_Image1","source","item_level_lock_png")
				])
			,
	...
	return LevelItem;
})(eui.Skin);generateEUI.paths['resource/mySkin/component/ProgressStar.exml'] = window.skins.ProgressStar = (function (_super) {
	...
	function ProgressStar() {
		...
		this.states = [
			...
			,
			new eui.State ("star_1_light",
				[
					new eui.SetProperty("_Image1","source","smallStar_png")
				])
		];
	}
	...
	return ProgressStar;
})(eui.Skin);generateEUI.paths['resource/mySkin/component/ToolItem.exml'] = window.skins.ToolItem = (function (_super) {
	...
	function ToolItem() {
		...
		this.states = [
			...
			new eui.State ("color",
				[
					new eui.SetProperty("icon_tool","source","prop_colorBall_png")
				])
			,
			new eui.State ("guid",
				[
			...
			new eui.State ("hummer",
				[
					new eui.SetProperty("icon_tool","source","prop_hammer_png")
				])
		];
	}
	...
	return ToolItem;
})(eui.Skin);generateEUI.paths['resource/mySkin/component/ShopItem.exml'] = window.skins.ShopItem = (function (_super) {
	...
	function ShopItem() {
		...
		this.states = [
			...
			new eui.State ("color",
				[
					new eui.SetProperty("tool","currentState","color")
				])
			,
			new eui.State ("bomb",
				[
					new eui.SetProperty("tool","currentState","bomb")
				])
			,
			new eui.State ("guid",
				[
					new eui.SetProperty("tool","currentState","guid")
				])
		];
	}
	...
	return ShopItem;
})(eui.Skin);generateEUI.paths['resource/mySkin/component/Timer.exml'] = window.skins.Timer = (function (_super) {
	...
	return Timer;
})(eui.Skin);generateEUI.paths['resource/mySkin/GameModelPanel.exml'] = window.skins.GameModelPanel = (function (_super) {
...
})(eui.Skin);generateEUI.paths['resource/mySkin/ScoreBoard.exml'] = window.skins.ScoreBoard = (function (_super) {
	...
	_proto._Group3_i = function () {
		...
		t.y = 1;
		t.elementsContent = [this.pg_trace_i(),this.pg_thumb_i(),this.pg_thumb_mask_i(),this.pg_star_1_i(),this.pg_star_2_i(),this.pg_star_3_i(),this._Group2_i()];
		return t;
	};
	...
	return ScoreBoard;
})(eui.Skin);generateEUI.paths['resource/mySkin/GamePage.exml'] = window.skins.GamePage = (function (_super) {
	...
	function GamePage() {
		_super.call(this);
		this.skinParts = ["bg","g_bubble","g_guidLine","g_comboEffect","curtain","border","dead_line","icon_arrow","score_board","time_board","g_handle","tool_hummer","tool_bomb","tool_color","tool_guid","g_tool","btn_change","btn_pause","l_coin","gray_mask","icon_ready","btn_begin"];
		
		this.height = 1136;
		this.width = 640;
		this.elementsContent = [this.bg_i(),this.g_bubble_i(),this.g_guidLine_i(),this.g_comboEffect_i(),this.curtain_i(),this.border_i(),this.dead_line_i(),this.icon_arrow_i(),this.score_board_i(),this.time_board_i(),this.g_handle_i(),this.g_tool_i(),this.btn_change_i(),this.btn_pause_i(),this._Group1_i(),this.gray_mask_i(),this.icon_ready_i(),this.btn_begin_i()];
	}
	...
	return GamePage;
})(eui.Skin);generateEUI.paths['resource/mySkin/HelpPage.exml'] = window.skins.HelpPage = (function (_super) {
	...
	function HelpPage() {
		...
		this.elementsContent = [this._Image1_i(),this.btn_return_i(),this._Image2_i(),this._Image3_i(),this._Image4_i(),this._Image5_i(),this._Image6_i(),this._Image7_i(),this._Image8_i(),this._Image9_i(),this._Image10_i()];
	}
	...
	return HelpPage;
})(eui.Skin);generateEUI.paths['resource/mySkin/LevelPage.exml'] = window.skins.LevelPage = (function (_super) {
	...
	function LevelPage() {
		...
		this.height = 1136;
		this.elementsContent = [this._Image1_i(),this.btn_return_i(),this.bl_completion_i(),this._Image2_i(),this.s_container_i(),this.g_pages_i(),this._Image3_i()];
	}
	...
	return LevelPage;
})(eui.Skin);generateEUI.paths['resource/mySkin/MenuPage.exml'] = window.skins.MenuPage = (function (_super) {
	...
	return MenuPage;
})(eui.Skin);generateEUI.paths['resource/mySkin/MsgPanel.exml'] = window.skins.MsgPanel = (function (_super) {
	...
	return MsgPanel;
})(eui.Skin);generateEUI.paths['resource/mySkin/PausePanel.exml'] = window.skins.PausePanel = (function (_super) {
	...
	var PausePanel$Skin7 = 	(function (_super) {
		...
		function PausePanel$Skin7() {
			...
			this.states = [
				...
				new eui.State ("down",
					[
						new eui.SetProperty("_Image1","source","btn_bgm_down_png")
					])
				,
				new eui.State ("disabled",
					[
	...
	var PausePanel$Skin8 = 	(function (_super) {
		...
		function PausePanel$Skin8() {
			...
			this.states = [
				...
				new eui.State ("down",
					[
						new eui.SetProperty("_Image1","source","btn_music_effect_down_png")
					])
				,
				new eui.State ("disabled",
					[
	...
	function PausePanel() {
		...
		this.elementsContent = [this._Image1_i(),this.btn_close_i(),this.btn_back_i(),this.btn_last_i(),this.btn_continue_i(),this.btn_restart_i(),this.btn_music_i(),this.btn_voice_i()];
	}
	...
	return PausePanel;
})(eui.Skin);generateEUI.paths['resource/mySkin/ResultPanel.exml'] = window.skins.ResultPanel = (function (_super) {
	__extends(ResultPanel, _super);
	function ResultPanel() {
		_super.call(this);
		this.skinParts = ["icon_pass","icon_result","icon_completion","g_completion","bl_score","bl_maxScore","btn_back","btn_restart","btn_next"];
		
		this.elementsContent = [this._Image1_i(),this.icon_pass_i(),this._Image2_i(),this.icon_result_i(),this._Group1_i(),this.bl_score_i(),this.bl_maxScore_i(),this.btn_back_i(),this.btn_restart_i()];
	...
	return ResultPanel;
})(eui.Skin);generateEUI.paths['resource/mySkin/ShopPage.exml'] = window.skins.ShopPage = (function (_super) {
	...
	var ShopPage$Skin9 = 	(function (_super) {
		...
		function ShopPage$Skin9() {
			...
			this.states = [
				...
				new eui.State ("down",
					[
						new eui.SetProperty("_Image1","source","btn_buy_down_png")
					])
				,
				new eui.State ("disabled",
					[
	...
	function ShopPage() {
		_super.call(this);
		this.skinParts = ["l_coin","btn_return","btn_pay","btn_min","btn_add","g_btns","c_hummer","c_bomb","c_color","c_guid","tool_hummer","bl_cost_hummer","bl_count_hummer","g_hummer","tool_bomb","bl_cost_bomb","bl_count_bomb","g_bomb","tool_color","bl_cost_color","bl_count_color","g_color","tool_guid","bl_cost_guid","bl_count_guid","g_guid","g_tool"];
		
		this.elementsContent = [this._Image1_i(),this._Image2_i(),this._Group1_i(),this.btn_return_i(),this.btn_pay_i(),this.g_btns_i(),this.g_tool_i()];
	}
	...
	_proto.g_tool_i = function () {
		...
		t.touchEnabled = false;
		t.y = 242;
		t.elementsContent = [this.c_hummer_i(),this.c_bomb_i(),this.c_color_i(),this.c_guid_i(),this.g_hummer_i(),this.g_bomb_i(),this.g_color_i(),this.g_guid_i()];
		return t;
	};
