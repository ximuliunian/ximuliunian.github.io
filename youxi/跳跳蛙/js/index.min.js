var lefts=Math.floor(Math.random()*200);var _timer=parseInt(Date.now()+Math.random()*100000000000);window.shareData={imgUrl:"icon.jpg",timeLineLink:"http://url.cn/Zy7vkz?timer="+_timer,tTitle:"蛙蛙跳",tContent:"小荷轻轻飘，青蛙跳跳跳~~"};
...
resetGame();}});Game.$el.btnShare.bind(util.mousedown,function(a){if(Game.isOver){Game.$el.share.show();}return true;});Game.$el.btnMore.bind(util.mousedown,function(b){if(Game.isOver){var a=/micromessenger/.test(window.navigator.userAgent.toLowerCase())?"http://www.6m5m.com":"http://www.6m5m.com/";
